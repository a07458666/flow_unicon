...
def load_corrupted_dataset(dname, severity, data_dir='./dataset', batch_size=256, cuda=True, workers=4):
...
def rotate_load_dataset(dname, angle, data_dir='./dataset', batch_size=256, cuda=True, workers=4):
...
def cross_load_dataset(dname_source, dname_target, data_dir='./dataset', batch_size=256,
                       cuda=True, workers=4):
